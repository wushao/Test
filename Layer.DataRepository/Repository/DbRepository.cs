...
namespace Layer.DataRepository
{
    /// <summary>
    /// 描述：数据库仓储基类类
    /// 作者：Coldairarrow
    ...
    public class DbRepository : IRepository
    {
        ...
        public DbRepository(Object param, Util.DatabaseType dbType, string entityNamespace)
        {
            BuildParam = param;
            _dbType = dbType;
        ...
        /// 数据库类型
        /// </summary>
        private Util.DatabaseType _dbType { get; set; }
        ...
        public virtual void Delete_Sql<T>(Expression<Func<T, bool>> condition) where T : class, new()
        {
            ...
            {
                var parameter = Util.DbProviderFactoryHelper.GetDbParameter(_dbType);
        ...
        {
            DbProviderFactory dbProviderFactory = Util.DbProviderFactoryHelper.GetDbProviderFactory(_dbType);
